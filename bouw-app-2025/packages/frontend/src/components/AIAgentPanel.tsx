        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setUiData({ ...uiData, components: e.target.value.split(",") })
              }
            />
          </Box>
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setUiData({ ...uiData, userFlow: e.target.value })
              }
            />
          </Box>
          <Box sx={{ width: "100%" }}>
            <FormControl fullWidth>
              ...
              <Select
                ...
                onChange={(e) =>
                  setUiData({
                    ...uiData,
                    mobileResponsiveness: e.target.value as boolean,
                  })
                }
              >
          ...
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setUiData({
                  ...uiData,
                  accessibilityScore: Number(e.target.value),
                })
              }
            />
          </Box>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                onChange={(e) =>
                  setContentData({
                    ...contentData,
                    type: e.target.value as ContentData["type"],
                  })
                }
              >
          ...
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setContentData({ ...contentData, topic: e.target.value })
              }
            />
          </Box>
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setContentData({ ...contentData, audience: e.target.value })
              }
            />
          </Box>
          <Box sx={{ width: "100%" }}>
            <FormControl fullWidth>
              ...
              <Select
                ...
                onChange={(e) =>
                  setContentData({
                    ...contentData,
                    tone: e.target.value as ContentData["tone"],
                  })
                }
              >
          ...
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setBehaviorData({
                  ...behaviorData,
                  pageViews: Number(e.target.value),
                })
              }
            />
          </Box>
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setBehaviorData({
                  ...behaviorData,
                  timeOnPage: Number(e.target.value),
                })
              }
            />
          </Box>
          ...
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setBehaviorData({
                  ...behaviorData,
                  userJourney: e.target.value.split(" -> "),
                })
              }
            />
          </Box>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setTestData({ ...testData, goals: e.target.value.split(",") })
              }
            />
          </Box>
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setTestData({
                  ...testData,
                  targetAreas: e.target.value.split(","),
                })
              }
            />
          </Box>
          ...
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setPerformanceData({
                  ...performanceData,
                  resourceSize: Number(e.target.value),
                })
              }
            />
          </Box>
          <Box sx={{ width: "100%" }}>
            <TextField
              ...
              onChange={(e) =>
                setPerformanceData({
                  ...performanceData,
                  apiCalls: Number(e.target.value),
                })
              }
            />
          </Box>
