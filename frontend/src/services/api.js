...
const auth = {
  ...
  changePassword: (passwordData) => instance.put('/auth/change-password', passwordData)
};
...
const projects = {
  ...
  // Team management
  addTeamMember: (id, userData) => instance.post(`/projects/${id}/team`, userData),
  removeTeamMember: (id, userId) => instance.delete(`/projects/${id}/team/${userId}`),
  // Stakeholder management
  addStakeholder: (id, stakeholderData) => instance.post(`/projects/${id}/stakeholders`, stakeholderData),
  removeStakeholder: (id, stakeholderId) => instance.delete(`/projects/${id}/stakeholders/${stakeholderId}`),
  // Risk management
  addRisk: (id, riskData) => instance.post(`/projects/${id}/risks`, riskData),
  updateRisk: (id, riskId, riskData) => instance.put(`/projects/${id}/risks/${riskId}`, riskData),
  deleteRisk: (id, riskId) => instance.delete(`/projects/${id}/risks/${riskId}`),
  // Issue management
  addIssue: (id, issueData) => instance.post(`/projects/${id}/issues`, issueData),
  updateIssue: (id, issueId, issueData) => instance.put(`/projects/${id}/issues/${issueId}`, issueData),
  deleteIssue: (id, issueId) => instance.delete(`/projects/${id}/issues/${issueId}`)
};
...
const invoices = {
  ...
  generatePdf: (id) => instance.get(`/invoices/${id}/pdf`, { responseType: 'blob' })
};
