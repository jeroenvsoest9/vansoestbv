                        ...
                        <CardContent>
                            ...
                            <Box sx={{ mt: 2 }}>
                                <Typography variant="subtitle1">
                                    Subtotal: {formatCurrency(formData.items.reduce((sum, item) => sum + item.subtotal, 0))}
                                </Typography>
                                <Typography variant="subtitle1">
                                    VAT: {formatCurrency(formData.items.reduce((sum, item) => sum + item.vatAmount, 0))}
                                </Typography>
                                <Typography variant="h6">
                                    Total: {formatCurrency(formData.items.reduce((sum, item) => sum + item.total, 0))}
                                </Typography>
                            </Box>
                        </CardContent>
                    </Card>
