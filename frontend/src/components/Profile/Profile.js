              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  error={
                    ...
                    Boolean(profileForm.errors.firstName)
                  }
                  helperText={
                    profileForm.touched.firstName &&
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  error={
                    ...
                    Boolean(profileForm.errors.lastName)
                  }
                  helperText={
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  error={
                    ...
                    Boolean(profileForm.errors.username)
                  }
                  helperText={
              ...
              <Grid item xs={12}>
                <Box sx={{ display: "flex", gap: 2 }}>
                  <Button
                    ...
                    color="primary"
                    disabled={
                      loading || profileForm.isSubmitting || !profileForm.dirty
                    }
                  >
