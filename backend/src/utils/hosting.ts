...
export const validateHostingConfig = (config: HostingConfig): void => {
  ...
  if (!Array.isArray(config.rewrites)) {
    throw new FirestoreError(
      'Rewrite rules must be an array',
      'invalid-argument',
      400
    );
  }
  ...
  if (!Array.isArray(config.redirects)) {
    throw new FirestoreError(
      'Redirect rules must be an array',
      'invalid-argument',
      400
    );
  }
...
export const validateRewriteRule = (rule: RewriteRule): void => {
  if (!rule.source || typeof rule.source !== 'string') {
    throw new FirestoreError(
      'Rewrite source must be a non-empty string',
      'invalid-argument',
      400
    );
  }
  ...
  if (rule.function && typeof rule.function !== 'string') {
    throw new FirestoreError(
      'Rewrite function must be a string',
      'invalid-argument',
      400
    );
  }
  ...
  if (rule.region && typeof rule.region !== 'string') {
    throw new FirestoreError(
      'Rewrite region must be a string',
      'invalid-argument',
      400
    );
  }
...
export const validateRedirectRule = (rule: RedirectRule): void => {
  if (!rule.source || typeof rule.source !== 'string') {
    throw new FirestoreError(
      'Redirect source must be a non-empty string',
      'invalid-argument',
      400
    );
  }
...
export const validateHeaderRule = (rule: HeaderRule): void => {
  if (!rule.source || typeof rule.source !== 'string') {
    throw new FirestoreError(
      'Header source must be a non-empty string',
      'invalid-argument',
      400
    );
  }
